"""Этот код определяет класс промежуточного программного обеспечения Django под
названием ElasticApmMiddleware, который предназначен для создания отдельных
транзакций для каждого запроса и ответа, а также для добавления тела ответа в
контекст Elastic APM (Мониторинг производительности приложений) для дальнейшего
анализа."""
